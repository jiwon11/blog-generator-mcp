...
function parseResponse(response: string): GenerateResult {
...
function parseFeedbackResponse(response: string): FeedbackResult {
...
export async function applyFeedbackToDraft(
