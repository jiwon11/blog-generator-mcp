import { ApplyFeedbackProInputSchema, TaskType, TaskStatus, StartDraftProOutputSchema } from "../types.js";
...
Returns:
  ...
  - status: 작업 상태`,
        ...
        try {
            ...
            // 백그라운드에서 피드백 반영
            runProFeedbackApplication(params.task_id, params.feedback, anthropicApiKey).catch(err => console.error("Pro feedback application error:", err));
            const output = {
...
//# sourceMappingURL=applyFeedbackPro.js.map