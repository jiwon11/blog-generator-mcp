...
Returns:
  ...
  - message: 안내 메시지`,
        ...
        try {
            ...
            runDraftGeneration(taskId, params.input_type, params.content, params.style, params.language, model, mergedInstructions, params.custom_prompt, apiKey).catch(console.error);
            const output = {
                task_id: taskId,
