...
Returns:
  ...
  - message: 안내 메시지`,
        ...
        try {
            ...
            // 백그라운드에서 Pro Mode 실행
            runProDraftGeneration(taskId, params.code_diff, params.dev_log, params.request, params.style, params.language, params.instructions, params.gemini_api_key, params.anthropic_api_key).catch(console.error);
            const output = {
                task_id: taskId,
